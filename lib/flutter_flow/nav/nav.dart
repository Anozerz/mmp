...
class AppStateNotifier extends ChangeNotifier {
  MMPAppFirebaseUser? initialUser;
  MMPAppFirebaseUser? user;
  ...
  void update(MMPAppFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'protocol',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Protocol')
                  : NavBarPage(
            ...
            FFRoute(
              name: 'JournalSuccessCopy',
              path: 'journalSuccessCopy',
              builder: (context, params) => JournalSuccessCopyWidget(),
            )
