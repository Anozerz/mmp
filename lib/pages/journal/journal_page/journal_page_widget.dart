...
class JournalPageWidget extends StatefulWidget {
  const JournalPageWidget({Key? key}) : super(key: key);
...
class _JournalPageWidgetState extends State<JournalPageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldTask1Controller ??= TextEditingController();
    _model.textFieldTask2Controller ??= TextEditingController();
    _model.textFieldTask3Controller ??= TextEditingController();
    _model.textFieldAvoidance1Controller ??= TextEditingController();
                                                      ...
                                                      children: [
                                                        Expanded(
                                                          child: TextFormField(
                                                            ...
                                                            maxLines: null,
                                                            validator: _model
                                                                .textFieldTask1ControllerValidator
                                                                .asValidator(
                                                                    context),
                                                          ),
                                                        ),
                                                      ...
                                                      children: [
                                                        Expanded(
                                                          child: TextFormField(
                                                            ...
                                                            maxLines: null,
                                                            validator: _model
                                                                .textFieldTask2ControllerValidator
                                                                .asValidator(
                                                                    context),
                                                          ),
                                                        ),
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        child: TextFormField(
                                                          ...
                                                          maxLines: null,
                                                          validator: _model
                                                              .textFieldTask3ControllerValidator
                                                              .asValidator(
                                                                  context),
                                                        ),
                                                      ),
