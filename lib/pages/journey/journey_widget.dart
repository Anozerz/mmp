                ...
                StreamBuilder<List<EntriesRecord>>(
                  stream: queryEntriesRecord(
                    queryBuilder: (entriesRecord) =>
                        entriesRecord.orderBy('createdTime'),
                  ),
                  builder: (context, snapshot) {
                    ...
                    List<EntriesRecord> listViewEntriesRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewEntriesRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewEntriesRecord =
                            listViewEntriesRecordList[listViewIndex];
                        return Container(
