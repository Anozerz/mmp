    ...
    return StreamBuilder<List<EntriesRecord>>(
      stream: queryEntriesRecord(
        queryBuilder: (entriesRecord) =>
            entriesRecord.where('user', isEqualTo: currentUserReference),
      ),
      builder: (context, snapshot) {
        ...
        List<EntriesRecord> statsEntriesRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowLineChart(
                                data: [
                                  FFLineChartData(
                                    ...
                                    yData: List.generate(
                                        random_data.randomInteger(7, 7),
                                        (index) =>
                                            random_data.randomDouble(1.0, 5.0)),
                                ...
                                chartStylingInfo: ChartStylingInfo(
                                  backgroundColor: Color(0x00EEEFF6),
                                  showBorder: false,
                                ),
